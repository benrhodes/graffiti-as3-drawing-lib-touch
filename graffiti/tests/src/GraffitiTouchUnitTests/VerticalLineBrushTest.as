package GraffitiTouchUnitTests
{
   ...
   public class VerticalLineBrushTest
   {		
      
      private var _verticalLineBrush:VerticalLineBrush;
      private var _testBitmapDataObjects:Vector.<BitmapData> = new Vector.<BitmapData>();
      
      [Before]
      public function setUp():void
      {
         _verticalLineBrush = new VerticalLineBrush(20, 0x000000, 1);
      }
      
      [After]
      public function tearDown():void
      {
         _verticalLineBrush = null;
      ...
      public function apply_TwoInteraction_DrawsCorrectGraphics():void
      {
         ...
         drawingData.push(1.25,-10,401.25,390,401.25,410,398.75,410,-1.25,10,-1.25,-10,1.25,-10,-1.25,390,398.75,-10,401.25,-10,401.25,10,1.25,410,-1.25,410,-1.25,390);
         
         var expectedDrawingLayer:Sprite = new Sprite();
         _verticalLineBrush.applyGraphicsStyle(expectedDrawingLayer);
         ...
         _verticalLineBrush.applyGraphicsStyle(drawingLayer);
         ...
         _verticalLineBrush.apply(drawingLayer, interactions);
      ...
      public function cacheToBitmap_DrawingLayerHasContent_BitmapShouldContainDrawingLayerContent():void
      {
         ...
         var actual:BitmapData = generateBitmap(400, 400, true, false);
         _verticalLineBrush.cacheToBitmap(actual, drawingLayer);
         _testBitmapDataObjects.push(expected);
         _testBitmapDataObjects.push(actual);
