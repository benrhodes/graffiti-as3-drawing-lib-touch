package GraffitiTouchUnitTests
{
   ...
   public class BackwardLineBrushTest
   {		
      
      private var _backwardLineBrush:BackwardLineBrush;
      private var _testBitmapDataObjects:Vector.<BitmapData> = new Vector.<BitmapData>();
      
      [Before]
      public function setUp():void
      {
         _backwardLineBrush = new BackwardLineBrush(20, 0x000000, 1);
      }
      
      [After]
      public function tearDown():void
      {
         _backwardLineBrush = null;
      ...
      public function apply_TwoInteraction_DrawsCorrectGraphics():void
      {
         ...
         commands.push(1,2,2,2,2,2,1,2,2,2,2,2)
         drawingData.push(-10,-10,-7.5,-10,10,10,410,410,407.5,410,390,390,-10,390,390,-10,392.5,-10,410,10,10,410,7.5,410);
         
         var expectedDrawingLayer:Sprite = new Sprite();
         _backwardLineBrush.applyGraphicsStyle(expectedDrawingLayer);
         ...
         _backwardLineBrush.applyGraphicsStyle(drawingLayer);
         ...
         _backwardLineBrush.apply(drawingLayer, interactions);
      ...
      public function cacheToBitmap_DrawingLayerHasContent_BitmapShouldContainDrawingLayerContent():void
      {
         ...
         var actual:BitmapData = generateBitmap(400, 400, true, false);
         _backwardLineBrush.cacheToBitmap(actual, drawingLayer);
         _testBitmapDataObjects.push(expected);
         _testBitmapDataObjects.push(actual);
