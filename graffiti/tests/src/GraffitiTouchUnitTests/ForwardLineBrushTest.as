package GraffitiTouchUnitTests
{
   ...
   public class ForwardLineBrushTest
   {		
      
      private var _forwardLineBrush:ForwardLineBrush;
      private var _testBitmapDataObjects:Vector.<BitmapData> = new Vector.<BitmapData>();
      
      [Before]
      public function setUp():void
      {
         _forwardLineBrush = new ForwardLineBrush(20, 0x000000, 1);
      }
      
      [After]
      public function tearDown():void
      {
         _forwardLineBrush = null;
      ...
      public function apply_TwoInteraction_DrawsCorrectGraphics():void
      {
         ...
         commands.push(1,2,2,2,2,2,2,2,1,2,2,2,2,2,2);
         drawingData.push(-10,10,7.5,-10,10,-10,410,390,392.5,410,390,410,-7.5,10,-10,10,-10,410,390,10,407.5,-10,410,-10,10,390,-7.5,410,-10,410);
         
         var expectedDrawingLayer:Sprite = new Sprite();
         _forwardLineBrush.applyGraphicsStyle(expectedDrawingLayer);
         ...
         _forwardLineBrush.applyGraphicsStyle(drawingLayer);
         ...
         _forwardLineBrush.apply(drawingLayer, interactions);
      ...
      public function cacheToBitmap_DrawingLayerHasContent_BitmapShouldContainDrawingLayerContent():void
      {
         ...
         var actual:BitmapData = generateBitmap(400, 400, true, false);
         _forwardLineBrush.cacheToBitmap(actual, drawingLayer);
         _testBitmapDataObjects.push(expected);
         _testBitmapDataObjects.push(actual);
