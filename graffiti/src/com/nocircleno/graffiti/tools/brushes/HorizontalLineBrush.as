...
package com.nocircleno.graffiti.tools.brushes
{
   ...
   public class HorizontalLineBrush extends Brush implements IBrush
   {
      ...
      /**
       * The <code>HorizontalLineBrush</code> constructor.
       * 
       ...
       */
      public function HorizontalLineBrush(brushSize:Number = 4, brushColor:uint = 0x000000, brushAlpha:Number = 1, bitmapCacheRenderMode:String = null)
      {
      ...
      public function apply(drawingLayer:Sprite, interactionInstances:Vector.<InteractionInstance>):void
      {
         ...
         for(var i:int=0; i<_numberInteractions; i++)
         {
            ...
            {   
               ...
               drawingData.push(_drawPoint1.y - _sixteenthSize);
               
               commands.push(GraphicsPathCommand.LINE_TO);
               drawingData.push(_drawPoint2.x + _halfSize);
               drawingData.push(_drawPoint2.y - _sixteenthSize);
