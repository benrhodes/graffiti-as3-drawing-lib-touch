...
package com.nocircleno.graffiti.tools.brushes
{
   ...
   public class VerticalLineBrush extends Brush implements IBrush
   {  
      ...
      /**
       * The <code>VerticalLineBrush</code> constructor.
       * 
       ...
       */
      public function VerticalLineBrush(brushSize:Number = 4, brushColor:uint = 0x000000, brushAlpha:Number = 1, bitmapCacheRenderMode:String = null)
      {
         super(brushSize, brushColor, brushAlpha, bitmapCacheRenderMode);
      }
      
      /**
       * The <code>cacheToBitmap</code> method will write the drawing layer to the canvas bitmap.
       *
      ...
      public function apply(drawingLayer:Sprite, interactionInstances:Vector.<InteractionInstance>):void
      {
         ...
         for(var i:int=0; i<_numberInteractions; i++)
         {
            ...
            if(_drawPoint1.y < _drawPoint2.y)
            {
               commands.push(GraphicsPathCommand.MOVE_TO);
               drawingData.push(_drawPoint1.x + _sixteenthSize);
               drawingData.push(_drawPoint1.y - _halfSize);
               
               commands.push(GraphicsPathCommand.LINE_TO);
               drawingData.push(_drawPoint2.x + _sixteenthSize);
