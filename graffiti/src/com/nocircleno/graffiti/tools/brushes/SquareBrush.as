...
package com.nocircleno.graffiti.tools.brushes
{
   ...
   public class SquareBrush extends Brush implements IBrush
   {
      ...
      /**
       * The <code>SquareBrush</code> constructor.
       * 
       ...
       */
      public function SquareBrush(brushSize:Number = 4, brushColor:uint = 0x000000, brushAlpha:Number = 1, bitmapCacheRenderMode:String = null)
      {
