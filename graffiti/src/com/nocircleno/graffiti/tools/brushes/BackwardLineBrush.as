...
package com.nocircleno.graffiti.tools.brushes
{
   ...
   public class BackwardLineBrush extends Brush implements IBrush
   {
      ...
      /**
       * The <code>BackwardLineBrush</code> constructor.
       * 
       ...
       */
      public function BackwardLineBrush(brushSize:Number = 4, brushColor:uint = 0x000000, brushAlpha:Number = 1, bitmapCacheRenderMode:String = null)
      {
